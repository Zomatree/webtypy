...
class _SharedArrayBufferOptions(TypedDict):
    maxByteLength: NotRequired[int]

class SharedArrayBuffer(Function):
    byteLength: int
    growable: bool
    maxByteLength: int
    ...
    def __init__(self, length: int) -> None: ...
    @overload
    def __init__(self, length: int, options: _SharedArrayBufferOptions) -> None: ...

    def grow(self, newLength: int) -> None: ...
    @overload
    def slice(self) -> Self: ...
    @overload
    def slice(self, begin: int) -> Self: ...
...
class BigInt(Function):
    def __init__(self, value: str | int | bool | BigInt) -> None: ...

    @classmethod
    def asIntN(cls, bits: int, bigint: Self) -> int: ...
    @classmethod
    def asUIntN(cls, bits: int, bigint: Self) -> int: ...
...
class DataView(Function):
    ...
    @overload
    def __init__(self, buffer: ArrayBuffer | SharedArrayBuffer) -> None: ...
    @overload
    def __init__(self, buffer: ArrayBuffer | SharedArrayBuffer, byteOffset: int) -> None: ...
    @overload
    def __init__(self, buffer: ArrayBuffer | SharedArrayBuffer, byteOffset: int, byteLength: int) -> None: ...

    @overload
    def getBigInt64(self, byteOffset: int) -> BigInt: ...
    @overload
    def getBigInt64(self, byteOffset: int, littleEndian: bool) -> BigInt: ...
    @overload
    def getBigUInt64(self, byteOffset: int) -> BigInt: ...
    @overload
    def getBigUInt64(self, byteOffset: int, littleEndian: bool) -> BigInt: ...
    @overload
    def getFloat32(self, byteOffset: int) -> float: ...
    @overload
    def getFloat32(self, byteOffset: int, littleEndian: bool) -> float: ...
    @overload
    def getFloat64(self, byteOffset: int) -> float: ...
    @overload
    def getFloat64(self, byteOffset: int, littleEndian: bool) -> float: ...
    @overload
    def getInt16(self, byteOffset: int) -> int: ...
    @overload
    def getInt16(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def getInt32(self, byteOffset: int) -> int: ...
    @overload
    def getInt32(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def getInt8(self, byteOffset: int) -> int: ...
    @overload
    def getInt8(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def getUInt16(self, byteOffset: int) -> int: ...
    @overload
    def getUInt16(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def getUInt32(self, byteOffset: int) -> int: ...
    @overload
    def getUInt32(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def getUInt8(self, byteOffset: int) -> int: ...
    @overload
    def getUInt8(self, byteOffset: int, littleEndian: bool) -> int: ...
    @overload
    def setBigInt64(self, byteOffset: int, value: BigInt) -> None: ...
    @overload
    def setBigInt64(self, byteOffset: int, value: BigInt, littleEndian: bool) -> None: ...
    @overload
    def setBigUInt64(self, byteOffset: int, value: BigInt) -> None: ...
    @overload
    def setBigUInt64(self, byteOffset: int, value: BigInt, littleEndian: bool) -> None: ...
    @overload
    def setFloat32(self, byteOffset: int, value: float) -> None: ...
    @overload
    def setFloat32(self, byteOffset: int, value: float, littleEndian: bool) -> None: ...
    @overload
    def setFloat64(self, byteOffset: int, value: float) -> None: ...
    @overload
    def setFloat64(self, byteOffset: int, value: float, littleEndian: bool) -> None: ...
    @overload
    def setInt16(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setInt16(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
    @overload
    def setInt32(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setInt32(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
    @overload
    def setInt8(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setInt8(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
    @overload
    def setUInt16(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setUInt16(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
    @overload
    def setUInt32(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setUInt32(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
    @overload
    def setUInt8(self, byteOffset: int, value: int) -> None: ...
    @overload
    def setUInt8(self, byteOffset: int, value: int, littleEndian: bool) -> None: ...
