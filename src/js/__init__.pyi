...
class MediaList:
    ...
    @overload
    def deleteMedium(self, oldMedium: str) -> void: ...
    @overload
    def appendMedium(self, newMedium: str) -> void: ...
...
class CSSStyleDeclaration:
    ...
    @overload
    def setProperty(self, propertyName: str, value: str, priority: str) -> void: ...
    length: int
    def item(self, index: int) -> str: ...
    parentRule: CSSRule
    cssText: CSSOMString
...
class CSSPrimitiveValue(CSSValue):
    ...
    CSS_RGBCOLOR = 25
    primitiveType: int
    def setFloatValue(self, unitType: int, floatValue: float) -> void: ...
    def getFloatValue(self, unitType: int) -> float: ...
    def setStringValue(self, stringType: int, stringValue: str) -> void: ...
